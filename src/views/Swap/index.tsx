        ...
        <Flex flexDirection="column" >
          <StyledSwapContainer $isChartExpanded={isChartExpanded}>
            <StyledInputCurrencyWrapper mt={isChartExpanded ? '24px' : '0'} mr={isChartExpanded ? '0' : '0'}>
              <div style={{ border: '1px solid rgba(180,182,208,.12)', background: 'rgba(14,19,48,0.5)' , borderRadius:'20px'}} >
                <CurrencyInputHeader
                  title={t('Swap')}
          ...
          {isChartExpanded && (
            <Box style={styles.container} display={['none', null, null, 'block']} width="100%" height="100%">
              <Footer variant="side" />
            </Box>
          )}
        </Flex>
