...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and DEXO pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and DEXO pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from DEXO pool', data)
  }
